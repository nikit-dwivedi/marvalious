...
const { addRigsAmount, getRigs, addRigSetting, editRigSetting, getAllCustomer, addPartnershipByAdmin, getBalanceById, allBalance } = require('../controllers/admin.controller');
