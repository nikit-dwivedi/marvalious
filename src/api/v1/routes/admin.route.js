...
const { addRigsAmount, getRigs, addRigSetting, editRigSetting, getAllCustomer, addPartnershipByAdmin, getBalanceById, allBalance, editKycVerified } = require('../controllers/admin.controller');
